...
dpk12 = np.load(f'{ccl_responses_path}/dpk12.npy')
dpk34 = np.load(f'{ccl_responses_path}/dpk34.npy')
...
plt.figure()
# plt.plot(k_1overMpc_hm, dpk12[a_idx, :] / pk2d[a_idx, :], label=f'dpk12, a={a_arr[a_idx]}, z_hm={z_hm}')
# plt.plot(k_1overMpc_hm, dpk34[a_idx, :] / pk2d[a_idx, :], label=f'dpk34, a={a_arr[a_idx]}, z_hm={z_hm}', ls='--')
...
plt.plot(k_1overMpc_su, R1_mm_su[z_idx_su, :], label=f'dpk34, a={a_arr[a_idx_hm]:.2f}, z={z_su:.2f}')
plt.legend()
plt.xlim(1e-2, 2)
plt.ylim(0., 7)
plt.xscale('log')
